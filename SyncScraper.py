...
class SyncStockScraper(ABC):
    ...
    @abstractmethod
    def get_yesterday_prices(self) -> None:
        """
    ...
    @abstractmethod
    def get_historical_prices(self, start_date, end_date) -> None:
        """
    ...
    @abstractmethod
    def get_companies_info(self, companies) -> None:
        """
    ...
    @staticmethod
    def wait_until_file_downloaded(file_path, error_file_path, timeout=30) -> bool:
        """
    ...
    @staticmethod
    def check_if_file_exists(file_path, remove=False) -> bool:
        """
